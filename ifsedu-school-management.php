...
function educore_execute_database_migration() {
    ...
    $sql_exams = "CREATE TABLE {$table_exams} (
        ...
        subject_ids longtext DEFAULT '' NOT NULL,
        start_date date NOT NULL,
        end_date date NOT NULL,
        att_start_date date DEFAULT NULL,
        att_end_date date DEFAULT NULL,
        min_attendance_pct decimal(5,2) DEFAULT 75.00 NOT NULL,
        total_working_days int(11) DEFAULT 0 NOT NULL,
        include_attendance varchar(10) DEFAULT 'yes' NOT NULL,
        fee_clear_month varchar(30) DEFAULT '' NOT NULL,
        weightage_pct decimal(5,2) DEFAULT 100.00 NOT NULL,
        enable_term_contrib varchar(10) DEFAULT 'no' NOT NULL,
        term_weights_json longtext DEFAULT '' NOT NULL,
