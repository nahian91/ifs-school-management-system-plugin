...
function educore_student_attendance_log_view( $classes ) {
    ...
    <div class="ifs-educore-attendance-reports-root">
        ...
        <div class="no-print ifs-educore-top-nav-container">
        ...
        <?php if ( 'today' === $active_tab ) : ?>
            ...
            <div class="no-print ifs-educore-filter-top-bar">
                <!-- Filter for Class & Section -->
                <div class="ifs-educore-filter-controls-group">
                    <label style="font-size:13px; font-weight:700; color:#334155;"><?php esc_html_e( 'Filter Sheet:', 'ifsedu-school-management' ); ?></label>
                    <select id="ifs_sheet_class_filter" class="ifs-educore-filter-select">
                    ...
                    <input type="text" id="ifs_sheet_section_search" placeholder="<?php esc_attr_e( 'Search Section / Stream...', 'ifsedu-school-management' ); ?>" class="ifs-educore-filter-input" style="max-width:200px;">
                </div>

                <button type="button" onclick="window.print();" class="ifs-educore-btn-print-sheet">
            ...
            <div class="ifs-official-sheet-container">
                ...
                <!-- Title & Meta Banner -->
                <div style="text-align:center; font-size:16px; font-weight:900; text-transform:capitalize; margin-bottom:8px;">
                                        ...
                                        <?php if ( 'exam' === $report_mode ) : ?>
                                            ...
                                            <td style="padding:12px 16px; text-align:right;">
                                                <?php if ( 'Present' === $status ) : ?>
                                                    <span style="background:#ecfdf5; color:#047857; padding:4px 10px; border-radius:6px; font-weight:700;"><span class="dashicons dashicons-yes-alt"></span> <?php esc_html_e( 'Present', 'ifsedu-school-management' ); ?></span>
                                                <?php elseif ( 'Absent' === $status ) : ?>
                                                    <span style="background:#fef2f2; color:#dc2626; padding:4px 10px; border-radius:6px; font-weight:700;"><span class="dashicons dashicons-dismiss"></span> <?php esc_html_e( 'Absent', 'ifsedu-school-management' ); ?></span>
                                                <?php else : ?>
                                                    <span style="background:#fffbeb; color:#d97706; padding:4px 10px; border-radius:6px; font-weight:700;"><span class="dashicons dashicons-warning"></span> <?php esc_html_e( 'Late / Expelled', 'ifsedu-school-management' ); ?></span>
                                                <?php endif; ?>
                                            </td>
                                        <?php else : ?>
                                            ...
                                            <td style="padding:12px 16px; text-align:right;">
                                                ...
                                                <?php elseif ( 'Absent' === $status ) : ?>
                                                    <span style="background:#fef2f2; color:#dc2626; padding:4px 10px; border-radius:6px; font-weight:700;"><span class="dashicons dashicons-dismiss"></span> <?php esc_html_e( 'Absent', 'ifsedu-school-management' ); ?></span>
                                                <?php else : ?>
                                                    <span style="background:#fffbeb; color:#d97706; padding:4px 10px; border-radius:6px; font-weight:700;"><span class="dashicons dashicons-clock"></span> <?php esc_html_e( 'Late', 'ifsedu-school-management' ); ?></span>
                                                <?php endif; ?>
                                            </td>
                                        <?php endif; ?>
                                    </tr>
