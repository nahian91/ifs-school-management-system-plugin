...
/**
 * Global Dashboard Asset Injector (CSS & JavaScript)
 */
function educore_dashboard_render_assets() {
    ...
    ?>
    <style id="educore-dashboard-styles">
        :root {
            --ifs-primary: #00523c;
            --ifs-primary-hover: #003e2d;
            --ifs-primary-soft: #ecfdf5;
            --ifs-primary-border: #a7f3d0;
            --ifs-emerald: #059669;
            --ifs-emerald-glow: rgba(16, 185, 129, 0.25);
            --ifs-emerald-border: rgba(16, 185, 129, 0.3);
            --ifs-blue: #2563eb;
            --ifs-blue-soft: #eff6ff;
            --ifs-danger: #dc2626;
            --ifs-danger-soft: #fef2f2;
            --ifs-dark: #0f172a;
            --ifs-slate-700: #334155;
            --ifs-slate-600: #475569;
            --ifs-slate-500: #64748b;
            ...
            --ifs-radius-md: 10px;
            --ifs-radius-lg: 14px;
            --ifs-shadow-sm: 0 1px 3px rgba(0, 0, 0, 0.05);
        }

        .ifs-educore-dash-root {
            margin-top: 20px;
            display: flex;
        ...
        /* Hero Banner */
        .ifs-educore-dash-hero-green {
            background: linear-gradient(135deg, var(--ifs-primary) 0%, #064e3b 100%);
        ...
        .ifs-educore-profile-flex {
            display: flex;
            align-items: center;
            gap: 20px;
        }
        .ifs-educore-profile-avatar {
            width: 76px;
            height: 76px;
            border-radius: 50%;
            border: 3px solid var(--ifs-primary-border);
            object-fit: cover;
            background: #ffffff;
        }
        .ifs-educore-hero-badge {
            background: rgba(255, 255, 255, 0.15);
            color: var(--ifs-primary-border);
            font-size: 11px;
            font-weight: 800;
        ...
        .ifs-educore-hero-meta-item {
            display: inline-flex;
            align-items: center;
            gap: 4px;
        }
        .ifs-educore-hero-meta-item .dashicons {
            font-size: 15px;
            width: 15px;
            height: 15px;
        }
        .ifs-educore-status-badge {
            background: var(--ifs-emerald-glow);
            color: var(--ifs-primary-border);
            padding: 3px 10px;
            border-radius: 8px;
            font-weight: 700;
            font-size: 12px;
            border: 1px solid var(--ifs-emerald-border);
        }
        .ifs-educore-status-badge .dashicons {
            font-size: 14px;
            width: 14px;
            height: 14px;
            vertical-align: middle;
        }
        .ifs-educore-banner-datetime-pill {
            text-align: right;
        ...
        .ifs-educore-banner-clock .dashicons {
            font-size: 16px;
            width: 16px;
            height: 16px;
            color: var(--ifs-primary-border);
        ...
        .ifs-educore-stat-top-row {
            display: flex;
            justify-content: space-between;
            align-items: flex-start;
        }
        .ifs-educore-stat-val-large {
            font-size: 30px;
            font-weight: 800;
            color: var(--ifs-dark);
            margin-top: 6px;
        ...
        .ifs-educore-stat-val-financial {
            font-size: 28px;
            font-weight: 800;
            margin-top: 6px;
            letter-spacing: -0.5px;
        ...
        .ifs-educore-stat-icon-badge .dashicons {
            font-size: 22px;
            width: 22px;
            height: 22px;
        }
        .ifs-educore-stat-hint {
            font-size: 12px;
            color: var(--ifs-slate-500);
            font-weight: 700;
            display: inline-block;
            margin-top: 4px;
        }
        .ifs-educore-stat-footer-row {
            border-top: 1px solid var(--ifs-slate-100);
            margin-top: 16px;
            padding-top: 12px;
            display: flex;
            justify-content: space-between;
        ...
        .ifs-educore-stat-footer-row a {
            text-decoration: none;
            font-weight: 700;
        }

        /* Bento Sub-Metrics Bar */
        .ifs-educore-bento-grid-4-sub {
            display: grid;
            grid-template-columns: repeat(4, 1fr);
            gap: 16px;
        }
        .ifs-educore-sub-stat-box {
            background: #ffffff;
            border: 1px solid var(--ifs-slate-200);
            border-radius: 12px;
            padding: 14px 18px;
        ...
        .ifs-educore-panel-card.ifs-card-fill {
            flex: 1;
        }
        .ifs-educore-panel-card-muted {
            background: var(--ifs-slate-50);
        }
        .ifs-educore-panel-header {
            display: flex;
            justify-content: space-between;
            align-items: center;
            margin-bottom: 16px;
        }
        .ifs-educore-panel-title {
            margin: 0;
            font-size: 15px;
            font-weight: 800;
            color: var(--ifs-dark);
        ...
        .ifs-educore-panel-title .dashicons {
            color: var(--ifs-primary);
        }
        .ifs-educore-view-all-link {
            font-size: 12px;
            font-weight: 800;
            color: var(--ifs-primary);
            text-decoration: none;
        ...
        /* Action Tiles / Command Docks */
        .ifs-educore-command-dock-grid {
            display: grid;
            grid-template-columns: repeat(3, 1fr);
            gap: 12px;
        }
        .ifs-educore-command-tile {
            background: var(--ifs-slate-50);
            border: 1px solid var(--ifs-slate-200);
        ...
        .ifs-educore-command-tile:hover {
            border-color: var(--ifs-primary);
            background: #ffffff;
            color: var(--ifs-primary);
        }
        .ifs-educore-command-tile .dashicons {
            color: var(--ifs-primary);
        }
        ...
        .ifs-educore-table tr:last-child td {
            border-bottom: none;
        }
        .ifs-educore-table-cell-right {
            text-align: right;
        }
        .ifs-educore-empty-state-td {
            text-align: center;
            color: var(--ifs-slate-400);
            padding: 28px;
        }

        /* Badges & Pills */
        .ifs-educore-badge-pill {
            display: inline-block;
            padding: 3px 8px;
        ...
        .ifs-educore-pill-green {
            background: var(--ifs-primary-soft);
            color: var(--ifs-emerald);
        }
        .ifs-educore-pill-blue {
            background: var(--ifs-blue-soft);
            color: var(--ifs-blue);
        }
        .ifs-educore-pill-red {
            background: var(--ifs-danger-soft);
            color: var(--ifs-danger);
        }
        .ifs-educore-text-green {
            color: var(--ifs-emerald);
        }
        .ifs-educore-text-blue {
            color: var(--ifs-blue);
        }
        .ifs-educore-text-red {
            color: var(--ifs-danger);
        }
        .ifs-educore-text-primary {
            color: var(--ifs-primary);
        }
        .ifs-educore-online-badge {
            font-size: 11px;
            font-weight: 800;
            color: var(--ifs-emerald);
            background: var(--ifs-primary-soft);
            padding: 2px 8px;
            border-radius: 6px;
            border: 1px solid var(--ifs-primary-border);
        }

        /* Class Attendance Progress */
        .ifs-educore-progress-box {
            background: var(--ifs-slate-50);
            border: 1px solid var(--ifs-slate-200);
            border-radius: 12px;
            padding: 16px;
        ...
        .ifs-educore-track {
            height: 10px;
            background: var(--ifs-slate-200);
            border-radius: 10px;
            overflow: hidden;
        }
        .ifs-educore-fill-primary {
            height: 100%;
        ...
        .ifs-educore-fill-gradient {
            height: 100%;
            background: linear-gradient(90deg, #047857 0%, #10b981 100%);
            border-radius: 6px;
            width: var(--progress-pct, 0%);
        }
        .ifs-educore-class-bars-wrapper {
            display: flex;
            flex-direction: column;
            gap: 12px;
        }
        ...
        .ifs-educore-notice-list-item:last-child {
            border-bottom: none;
        }

        /* Teacher Specific */
        .ifs-educore-teacher-unit-grid {
            display: grid;
            grid-template-columns: 1fr;
            gap: 14px;
        }
        .ifs-educore-teacher-unit-card {
            background: #ffffff;
            border: 1px solid var(--ifs-slate-200);
            border-radius: 12px;
            padding: 16px;
        ...
        .ifs-educore-subject-tag-list {
            display: flex;
            flex-wrap: wrap;
            gap: 6px;
            margin-top: 6px;
        }
        .ifs-educore-subject-pill {
            background: var(--ifs-slate-50);
            border: 1px solid var(--ifs-slate-200);
            padding: 3px 8px;
            border-radius: 6px;
        ...
        .ifs-educore-teacher-actions-row {
            display: flex;
            gap: 10px;
            border-top: 1px solid var(--ifs-slate-200);
            padding-top: 14px;
            margin-top: 12px;
        }
        .ifs-educore-tile-primary {
            background: var(--ifs-primary);
            color: #ffffff;
            border-color: var(--ifs-primary);
        }
        .ifs-educore-tile-primary .dashicons {
            color: #ffffff;
        }
        .ifs-educore-tile-primary:hover {
            background: var(--ifs-primary-hover);
            color: #ffffff;
        }

        /* Utility Helpers */
        .ifs-educore-empty-msg {
            color: var(--ifs-slate-400);
            font-size: 13px;
            margin: 0;
        }
        .ifs-educore-empty-box {
            background: var(--ifs-slate-50);
            border: 1px dashed var(--ifs-slate-400);
            border-radius: var(--ifs-radius-lg);
            padding: 40px 20px;
            text-align: center;
        }
        .ifs-educore-empty-box-icon {
            font-size: 36px;
            width: 36px;
            height: 36px;
            color: var(--ifs-slate-400);
        ...
        .ifs-educore-system-info {
            font-size: 12px;
            color: var(--ifs-slate-500);
            line-height: 1.8;
        }
        .ifs-educore-doc-stack {
            display: flex;
            flex-direction: column;
            gap: 12px;
        }
        .ifs-educore-command-row {
            flex-direction: row;
        ...
        .ifs-educore-command-row-compact {
            flex-direction: row;
            padding: 6px 12px;
            font-size: 12px;
            gap: 4px;
        }
        .ifs-educore-btn-wrap {
            margin-top: 12px;
        }
        .ifs-educore-w-full {
            flex: 1;
        ...
        @media (max-width: 1100px) {
            .ifs-educore-grid-4, .ifs-educore-grid-3, .ifs-educore-bento-grid-4-sub {
        ...
        @media (max-width: 650px) {
            .ifs-educore-grid-4, .ifs-educore-grid-3, .ifs-educore-bento-grid-4-sub, .ifs-educore-command-dock-grid {
                grid-template-columns: 1fr;
            }
            .ifs-educore-dash-hero-green {
                flex-direction: column;
            ...
            .ifs-educore-banner-date, .ifs-educore-banner-clock {
                justify-content: flex-start;
            }
        }
    </style>

    <script id="educore-dashboard-scripts">
...
function educore_dashboard_render_hero_profile( $user, $role_title, $extra_meta = array(), $action_btn = null ) {
    educore_dashboard_render_assets();
        ...
        <div class="ifs-educore-profile-flex">
            ...
            <div>
                ...
                <h2 class="ifs-educore-hero-title">
                    <?php
                    printf(
                        /* translators: 1: Greeting phrase, 2: User display name */
                ...
                <div class="ifs-educore-hero-meta-strip">
                    ...
                    &bull;
                    <span class="ifs-educore-hero-meta-item ifs-educore-status-badge">
                        <span class="dashicons dashicons-yes-alt"></span> <?php esc_html_e( 'ACCOUNT ACTIVE', 'ifsedu-school-management' ); ?>
                    </span>
                </div>
            </div>
        </div>
    ...
    <div class="ifs-educore-dash-root">
            ...
            <div class="ifs-educore-stat-bento">
                <div class="ifs-educore-stat-top-row">
                    <div>
                        ...
                        <div class="ifs-educore-stat-val-large"><?php echo esc_html( number_format( $total_students ) ); ?></div>
                        <span class="ifs-educore-stat-hint">
                            (<?php echo esc_html( $male_students ); ?> Male / <?php echo esc_html( $female_students ); ?> Female)
                        </span>
                    </div>
                    <div class="ifs-educore-stat-icon-badge ifs-educore-pill-blue">
                        <span class="dashicons dashicons-groups"></span>
                    </div>
                </div>
                <div class="ifs-educore-stat-footer-row">
                    <span class="ifs-educore-text-primary"><?php esc_html_e( 'Academic Classes', 'ifsedu-school-management' ); ?></span>
                    <a href="<?php echo esc_url( admin_url( 'admin.php?page=school_management_system&tab=students&sub=list' ) ); ?>" class="ifs-educore-text-blue"><?php esc_html_e( 'Directory &rarr;', 'ifsedu-school-management' ); ?></a>
                </div>
            </div>
            ...
            <div class="ifs-educore-stat-bento">
                <div class="ifs-educore-stat-top-row">
                    <div>
                        ...
                        <div class="ifs-educore-stat-val-large">
                            <?php echo esc_html( number_format( $present_today ) ); ?> <span class="ifs-educore-sub-stat-val ifs-educore-text-green">(<?php echo esc_html( $attendance_pct ); ?>%)</span>
                        </div>
                        <span class="ifs-educore-stat-hint">
                            <?php esc_html_e( 'Real-time classroom sync', 'ifsedu-school-management' ); ?>
                        </span>
                    </div>
                    <div class="ifs-educore-stat-icon-badge ifs-educore-pill-green">
                        <span class="dashicons dashicons-yes-alt"></span>
                    </div>
                </div>
                <div class="ifs-educore-stat-footer-row">
                    <span class="ifs-educore-text-green"><?php esc_html_e( 'Active Logins', 'ifsedu-school-management' ); ?></span>
                    <a href="<?php echo esc_url( admin_url( 'admin.php?page=school_management_system&tab=attendance&sub=daily' ) ); ?>" class="ifs-educore-text-green"><?php esc_html_e( 'Attendance &rarr;', 'ifsedu-school-management' ); ?></a>
                </div>
            </div>
            ...
            <div class="ifs-educore-stat-bento">
                <div class="ifs-educore-stat-top-row">
                    <div>
                        ...
                        <div class="ifs-educore-stat-val-large ifs-educore-text-red">
                    ...
                    <div class="ifs-educore-stat-icon-badge ifs-educore-pill-red">
                        <span class="dashicons dashicons-warning"></span>
                    </div>
                </div>
                <div class="ifs-educore-stat-footer-row">
                    <span class="ifs-educore-badge-pill ifs-educore-pill-red"><?php esc_html_e( 'Unexcused', 'ifsedu-school-management' ); ?></span>
                    <a href="<?php echo esc_url( admin_url( 'admin.php?page=school_management_system&tab=attendance&sub=reports' ) ); ?>" class="ifs-educore-text-red"><?php esc_html_e( 'Logs &rarr;', 'ifsedu-school-management' ); ?></a>
                </div>
            </div>
            ...
            <div class="ifs-educore-stat-bento">
                <div class="ifs-educore-stat-top-row">
                    <div>
                        ...
                        <div class="ifs-educore-stat-val-financial ifs-educore-text-primary">৳<?php echo esc_html( number_format( $today_fee_collection, 2 ) ); ?></div>
                        <span class="ifs-educore-stat-hint">
                ...
                <div class="ifs-educore-stat-footer-row">
                    <span class="ifs-educore-stat-hint"><?php esc_html_e( 'Daily Inflow', 'ifsedu-school-management' ); ?></span>
                    <a href="<?php echo esc_url( admin_url( 'admin.php?page=school_management_system&tab=fees&sub=collect' ) ); ?>" class="ifs-educore-text-primary"><?php esc_html_e( 'Collect Fee &rarr;', 'ifsedu-school-management' ); ?></a>
                </div>
            </div>
            ...
            <div class="ifs-educore-stat-bento">
                <div class="ifs-educore-stat-top-row">
                    <div>
                        ...
                        <div class="ifs-educore-stat-val-financial ifs-educore-text-red">৳<?php echo esc_html( number_format( $pending_receivables, 2 ) ); ?></div>
                        <span class="ifs-educore-stat-hint">
                ...
                <div class="ifs-educore-stat-footer-row">
                    <span class="ifs-educore-stat-hint"><?php esc_html_e( 'Outstanding', 'ifsedu-school-management' ); ?></span>
                    <a href="<?php echo esc_url( admin_url( 'admin.php?page=school_management_system&tab=fees&sub=list' ) ); ?>" class="ifs-educore-text-red"><?php esc_html_e( 'Audit Report &rarr;', 'ifsedu-school-management' ); ?></a>
                </div>
            </div>
            ...
            <div class="ifs-educore-stat-bento">
                <div class="ifs-educore-stat-top-row">
                    <div>
                        ...
                        <div class="ifs-educore-stat-val-large"><?php echo esc_html( $total_teachers ); ?></div>
                        <span class="ifs-educore-stat-hint">
                ...
                <div class="ifs-educore-stat-footer-row">
                    <span class="ifs-educore-text-green"><?php esc_html_e( 'Active Payroll', 'ifsedu-school-management' ); ?></span>
                    <a href="<?php echo esc_url( admin_url( 'admin.php?page=school_management_system&tab=staff' ) ); ?>" class="ifs-educore-text-primary"><?php esc_html_e( 'Faculty List &rarr;', 'ifsedu-school-management' ); ?></a>
                </div>
            </div>
        </div>
        ...
        <div class="ifs-educore-bento-grid-4-sub">
            <div class="ifs-educore-sub-stat-box">
                ...
                <span class="ifs-educore-sub-stat-val ifs-educore-text-primary">৳<?php echo esc_html( number_format( $month_collections, 2 ) ); ?></span>
            </div>
            <div class="ifs-educore-sub-stat-box">
                <span class="ifs-educore-sub-stat-label"><?php esc_html_e( 'Month General Expenses', 'ifsedu-school-management' ); ?></span>
                <span class="ifs-educore-sub-stat-val ifs-educore-text-red">৳<?php echo esc_html( number_format( $month_expenses, 2 ) ); ?></span>
            </div>
            <div class="ifs-educore-sub-stat-box">
                <span class="ifs-educore-sub-stat-label"><?php esc_html_e( 'Net Operating Cash (Total)', 'ifsedu-school-management' ); ?></span>
                <span class="ifs-educore-sub-stat-val ifs-educore-text-blue">৳<?php echo esc_html( number_format( $net_operating_cash, 2 ) ); ?></span>
            </div>
            <div class="ifs-educore-sub-stat-box">
        ...
        <div class="ifs-educore-split-layout">
            <div class="ifs-educore-col">
                ...
                <div class="ifs-educore-panel-card">
                    <div class="ifs-educore-panel-header">
                        ...
                        <a href="<?php echo esc_url( admin_url( 'admin.php?page=school_management_system&tab=fees&sub=list' ) ); ?>" class="ifs-educore-view-all-link"><?php esc_html_e( 'VIEW ALL &rarr;', 'ifsedu-school-management' ); ?></a>
                    </div>
                        ...
                        <table class="ifs-educore-table">
                            <thead>
                                <tr>
                                    ...
                                    <th class="ifs-educore-table-cell-right"><?php esc_html_e( 'Amount', 'ifsedu-school-management' ); ?></th>
                                </tr>
                            </thead>
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            <strong><?php echo esc_html( $trx->fee_type ); ?></strong>
                                            <span class="ifs-educore-stat-hint"><?php esc_html_e( 'Student Fee Ledger', 'ifsedu-school-management' ); ?></span>
                                        </td>
                                        <td><span class="ifs-educore-badge-pill"><?php echo esc_html( $trx->payment_method ); ?></span></td>
                                        <td><?php echo esc_html( $payment_date_formatted ); ?></td>
                                        <td class="ifs-educore-table-cell-right"><strong class="ifs-educore-text-green">+৳<?php echo esc_html( number_format( (float) $trx->paid_amount, 2 ) ); ?></strong></td>
                                    </tr>
                                <?php endforeach; else : ?>
                                    <tr><td colspan="5" class="ifs-educore-empty-state-td"><?php esc_html_e( 'No recent financial transactions found.', 'ifsedu-school-management' ); ?></td></tr>
                                <?php endif; ?>
                            </tbody>
                        </table>
                    </div>
                ...
                <div class="ifs-educore-panel-card ifs-card-fill">
                    <div class="ifs-educore-panel-header">
                        ...
                        <a href="<?php echo esc_url( admin_url( 'admin.php?page=school_management_system&tab=exams' ) ); ?>" class="ifs-educore-view-all-link"><?php esc_html_e( 'MANAGE EXAMS &rarr;', 'ifsedu-school-management' ); ?></a>
                    </div>
                    <?php if ( ! empty( $upcoming_exams ) ) : ?>
                        <div>
                            ...
                            ?>
                                <div class="ifs-educore-exam-card-item">
                                    <div>
                                        <strong class="ifs-educore-sub-stat-val"><?php echo esc_html( $exam->exam_name ); ?></strong>
                                        <div class="ifs-educore-stat-hint">
                                    ...
                                    <a href="<?php echo esc_url( admin_url( 'admin.php?page=school_management_system&tab=results&sub=marks' ) ); ?>" class="ifs-educore-command-tile ifs-educore-command-row-compact">
                                        <span class="dashicons dashicons-edit"></span> <?php esc_html_e( 'Marks', 'ifsedu-school-management' ); ?>
                                    </a>
                                </div>
                            <?php endforeach; ?>
                        </div>
                    <?php else : ?>
                        <p class="ifs-educore-empty-msg"><?php esc_html_e( 'No examination records found. Click below to schedule a new term exam.', 'ifsedu-school-management' ); ?></p>
                        <div class="ifs-educore-btn-wrap">
                            <a href="<?php echo esc_url( admin_url( 'admin.php?page=school_management_system&tab=exams&sub=add' ) ); ?>" class="ifs-educore-command-tile ifs-educore-command-row-compact">
            ...
            <div class="ifs-educore-col">
                ...
                <div class="ifs-educore-panel-card">
                    ...
                    <div class="ifs-educore-progress-box">
                        <div class="ifs-educore-progress-info">
                        ...
                        <div class="ifs-educore-track">
                            <div class="ifs-educore-fill-primary" style="--progress-pct: <?php echo esc_attr( min( 100, $attendance_pct ) ); ?>%;"></div>
                        </div>
                    </div>

                    <!-- Class-Wise Breakdown Progress Bars -->
                    <h4 class="ifs-educore-sub-stat-label">
                        <?php esc_html_e( 'Class-Wise Attendance Ratio', 'ifsedu-school-management' ); ?>
                    </h4>
                    <?php if ( ! empty( $class_attendance_summary ) ) : ?>
                        <div class="ifs-educore-class-bars-wrapper">
                            ...
                            ?>
                                <div>
                                    <div class="ifs-educore-progress-info">
                                        ...
                                        <span class="ifs-educore-text-green"><?php echo esc_html( $c_present ); ?>/<?php echo esc_html( $c_enrolled ); ?> (<?php echo esc_html( $c_pct ); ?>%)</span>
                                    </div>
                                    <div class="ifs-educore-track-sm">
                                        <div class="ifs-educore-fill-gradient" style="--progress-pct: <?php echo esc_attr( min( 100, $c_pct ) ); ?>%;"></div>
                                    </div>
                                </div>
                            <?php endforeach; ?>
                        </div>
                    <?php else : ?>
                        <p class="ifs-educore-empty-msg"><?php esc_html_e( 'No student enrollment records found to compute class breakdown.', 'ifsedu-school-management' ); ?></p>
                    <?php endif; ?>
                </div>
                ...
                <div class="ifs-educore-panel-card">
                    <div class="ifs-educore-panel-header">
                        ...
                        <a href="<?php echo esc_url( admin_url( 'admin.php?page=school_management_system&tab=notices&sub=add' ) ); ?>" class="ifs-educore-command-tile ifs-educore-command-row-compact">
                    ...
                    <?php if ( ! empty( $recent_admin_notices ) ) : ?>
                        <div>
                            ...
                            ?>
                                <div class="ifs-educore-notice-list-item">
                                    <div>
                                        <strong class="ifs-educore-sub-stat-val"><?php echo esc_html( $notice->title ); ?></strong>
                                        <div class="ifs-educore-stat-hint">
                                            <span><?php echo esc_html( $n_date_formatted ); ?></span> &bull; 
                                            <span class="ifs-educore-badge-pill"><?php echo esc_html( $n_aud ); ?></span>
                                        </div>
                                    </div>
                                </div>
                            <?php endforeach; ?>
                    ...
                    <?php else : ?>
                        <p class="ifs-educore-empty-msg"><?php esc_html_e( 'No notices published yet.', 'ifsedu-school-management' ); ?></p>
                    <?php endif; ?>
                </div>

                <!-- System & Environment Diagnostics -->
                <div class="ifs-educore-panel-card ifs-card-fill ifs-educore-panel-card-muted">
                    <div class="ifs-educore-panel-header">
                        <h3 class="ifs-educore-panel-title">
                            <span class="dashicons dashicons-dashboard"></span>
                            <?php esc_html_e( 'System & License Status', 'ifsedu-school-management' ); ?>
                        </h3>
                        <span class="ifs-educore-online-badge"><?php esc_html_e( 'ONLINE', 'ifsedu-school-management' ); ?></span>
                    </div>
                    <div class="ifs-educore-system-info">
            ...
            <div class="ifs-educore-stat-bento">
                <div class="ifs-educore-stat-top-row">
                    <div>
                        ...
                        <div class="ifs-educore-stat-val-large"><?php echo esc_html( $unique_classes_count ); ?></div>
                    </div>
                    <div class="ifs-educore-stat-icon-badge ifs-educore-pill-green">
                        <span class="dashicons dashicons-welcome-learn-more"></span>
                    </div>
            ...
            <div class="ifs-educore-stat-bento">
                <div class="ifs-educore-stat-top-row">
                    <div>
                        ...
                        <div class="ifs-educore-stat-val-large"><?php echo esc_html( $total_subjects_count ); ?></div>
                    </div>
                    <div class="ifs-educore-stat-icon-badge ifs-educore-pill-blue">
            ...
            <div class="ifs-educore-stat-bento">
                <div class="ifs-educore-stat-top-row">
                    <div>
                        ...
                        <div class="ifs-educore-stat-val-financial ifs-educore-text-green">
            ...
            <div class="ifs-educore-stat-bento">
                <div class="ifs-educore-stat-top-row">
                    <div>
                        ...
                        <div class="ifs-educore-stat-val-large"><?php echo esc_html( count( $teacher_notices ) ); ?></div>
                    </div>
                    <div class="ifs-educore-stat-icon-badge ifs-educore-pill-red">
                        <span class="dashicons dashicons-bell"></span>
                    </div>
        ...
        <div class="ifs-educore-split-layout">
            <div class="ifs-educore-col">
                <div class="ifs-educore-panel-card ifs-card-fill">
                            ...
                            ?>
                                <div class="ifs-educore-teacher-unit-card">
                                    <div>
                                        <div class="ifs-educore-panel-header">
                                            <div>
                                                <strong class="ifs-educore-sub-stat-val"><?php echo esc_html( $display_class_name ); ?></strong>
                                                <span class="ifs-educore-stat-hint">
                                                    <?php
                                            ...
                                            <span class="ifs-educore-badge-pill">
                                                <?php echo esc_html( count( $unit['subjects'] ) ); ?> <?php esc_html_e( 'Subjects', 'ifsedu-school-management' ); ?>
                                            </span>
                                        </div>

                                        <div class="ifs-educore-btn-wrap">
                                            <span class="ifs-educore-sub-stat-label"><?php esc_html_e( 'Assigned Curriculum:', 'ifsedu-school-management' ); ?></span>
                                    ...
                                    <div class="ifs-educore-teacher-actions-row">
                                        <a href="<?php echo esc_url( $att_url ); ?>" class="ifs-educore-command-tile ifs-educore-command-row-compact ifs-educore-w-full">
                                            <span class="dashicons dashicons-calendar-alt"></span> <?php esc_html_e( 'Attendance', 'ifsedu-school-management' ); ?>
                                        </a>
                                        <a href="<?php echo esc_url( $marks_url ); ?>" class="ifs-educore-command-tile ifs-educore-command-row-compact ifs-educore-tile-primary ifs-educore-w-full">
                                            <span class="dashicons dashicons-edit"></span> <?php esc_html_e( 'Marks', 'ifsedu-school-management' ); ?>
                                        </a>
                                    </div>
                                </div>
                    ...
                    <?php else : ?>
                        <div class="ifs-educore-empty-box">
                            <span class="dashicons dashicons-info ifs-educore-empty-box-icon"></span>
                            <p class="ifs-educore-empty-msg">
            ...
            <div class="ifs-educore-col">
                <div class="ifs-educore-panel-card ifs-card-fill">
                    ...
                    <?php if ( ! empty( $teacher_notices ) ) : ?>
                        <div>
                            ...
                            ?>
                                <div class="ifs-educore-notice-list-item">
                                    <div>
                                        <strong class="ifs-educore-sub-stat-val"><?php echo esc_html( $n->title ); ?></strong>
                                        <div class="ifs-educore-stat-hint">
                                            <?php echo esc_html( $n_date_formatted ); ?> &bull; 
                                            <span class="ifs-educore-badge-pill"><?php echo esc_html( $n_category ); ?></span>
                                        </div>
                                    </div>
                                    <a href="<?php echo esc_url( $notice_url ); ?>" class="ifs-educore-command-tile ifs-educore-command-row-compact">
                    ...
                    <?php else : ?>
                        <p class="ifs-educore-empty-msg"><?php esc_html_e( 'No notices found.', 'ifsedu-school-management' ); ?></p>
                    <?php endif; ?>
                </div>
            </div>
        </div>
    ...
    <div class="ifs-educore-dash-root">
            ...
            <div class="ifs-educore-stat-bento">
                <div class="ifs-educore-stat-top-row">
                    <div>
                        ...
                        <div class="ifs-educore-stat-val-financial ifs-educore-text-green">৳<?php echo esc_html( number_format( $today_income, 2 ) ); ?></div>
                    </div>
                    <div class="ifs-educore-stat-icon-badge ifs-educore-pill-green">
            ...
            <div class="ifs-educore-stat-bento">
                <div class="ifs-educore-stat-top-row">
                    <div>
                        ...
                        <div class="ifs-educore-stat-val-financial ifs-educore-text-blue">৳<?php echo esc_html( number_format( $month_income, 2 ) ); ?></div>
                    </div>
                    <div class="ifs-educore-stat-icon-badge ifs-educore-pill-blue">
                        <span class="dashicons dashicons-calendar-alt"></span>
                    </div>
            ...
            <div class="ifs-educore-stat-bento">
                <div class="ifs-educore-stat-top-row">
                    <div>
                        ...
                        <div class="ifs-educore-stat-val-financial ifs-educore-text-red">৳<?php echo esc_html( number_format( $month_exp, 2 ) ); ?></div>
                    </div>
                    <div class="ifs-educore-stat-icon-badge ifs-educore-pill-red">
        ...
        <div class="ifs-educore-panel-card">
            <div class="ifs-educore-panel-header">
                ...
                <a href="<?php echo esc_url( admin_url( 'admin.php?page=school_management_system&tab=accounting&sub=add' ) ); ?>" class="ifs-educore-command-tile ifs-educore-command-row-compact">
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    <span class="ifs-educore-badge-pill <?php echo 'Income' === $t->entry_type ? 'ifs-educore-pill-green' : 'ifs-educore-pill-red'; ?>">
                                        <?php echo esc_html( $t->entry_type ); ?>
                                    </span>
                                </td>
                                <td class="ifs-educore-table-cell-right">
                                    <strong class="<?php echo 'Income' === $t->entry_type ? 'ifs-educore-text-green' : 'ifs-educore-text-red'; ?>">
                                        ৳<?php echo esc_html( number_format( (float) $t->amount, 2 ) ); ?>
                                    </strong>
                                </td>
                            </tr>
                        <?php endforeach; else : ?>
                            <tr><td colspan="5" class="ifs-educore-empty-state-td"><?php esc_html_e( 'No transactions recorded yet.', 'ifsedu-school-management' ); ?></td></tr>
                        <?php endif; ?>
                    </tbody>
                </table>
            </div>
        ...
        <div class="ifs-educore-split-layout">
            <div class="ifs-educore-col">
                <div class="ifs-educore-panel-card ifs-card-fill">
                    ...
                    <?php else : ?>
                        <p class="ifs-educore-empty-msg"><?php esc_html_e( 'No active notices.', 'ifsedu-school-management' ); ?></p>
                    <?php endif; ?>
                </div>
            </div>
            ...
            <div class="ifs-educore-col">
                <div class="ifs-educore-panel-card ifs-card-fill">
                    ...
                    <div class="ifs-educore-doc-stack">
                        <a href="<?php echo esc_url( admin_url( 'admin.php?page=school_management_system&tab=students&sub=id_card' ) ); ?>" class="ifs-educore-command-tile ifs-educore-command-row">
                            <span class="dashicons dashicons-id"></span> 
                            <div>
                                <strong class="ifs-educore-sub-stat-val"><?php esc_html_e( 'Digital ID Card', 'ifsedu-school-management' ); ?></strong>
                                <span class="ifs-educore-stat-hint"><?php esc_html_e( 'Generate & print official school ID', 'ifsedu-school-management' ); ?></span>
                            </div>
                        </a>
                        <a href="<?php echo esc_url( admin_url( 'admin.php?page=school_management_system&tab=students&sub=admit_card' ) ); ?>" class="ifs-educore-command-tile ifs-educore-command-row">
                            <span class="dashicons dashicons-tickets-alt"></span> 
                            <div>
                                <strong class="ifs-educore-sub-stat-val"><?php esc_html_e( 'Admit Card', 'ifsedu-school-management' ); ?></strong>
                                <span class="ifs-educore-stat-hint"><?php esc_html_e( 'Examination entry pass card', 'ifsedu-school-management' ); ?></span>
                            </div>
                        </a>
                        <a href="<?php echo esc_url( admin_url( 'admin.php?page=school_management_system&tab=results&sub=report' ) ); ?>" class="ifs-educore-command-tile ifs-educore-command-row">
                            <span class="dashicons dashicons-media-document"></span> 
                            <div>
                                <strong class="ifs-educore-sub-stat-val"><?php esc_html_e( 'Academic Transcript', 'ifsedu-school-management' ); ?></strong>
                                <span class="ifs-educore-stat-hint"><?php esc_html_e( 'Term marksheets & GPA records', 'ifsedu-school-management' ); ?></span>
                            </div>
                        </a>
                    </div>
                </div>
