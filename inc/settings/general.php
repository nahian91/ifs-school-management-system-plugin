...
function educore_render_settings_general_view( $base_url ) {
    ...
    if ( 'POST' === $req_method && isset( $_POST['educore_save_general_settings'] ) ) {
        ...
        $school_phone   = isset( $_POST['school_phone'] ) ? sanitize_text_field( wp_unslash( $_POST['school_phone'] ) ) : '';
        $school_email   = isset( $_POST['school_email'] ) ? sanitize_email( wp_unslash( $_POST['school_email'] ) ) : '';
        $school_address = isset( $_POST['school_address'] ) ? sanitize_textarea_field( wp_unslash( $_POST['school_address'] ) ) : '';
        ...
        update_option( 'educore_school_phone', $school_phone );
        update_option( 'educore_school_email', $school_email );
        update_option( 'educore_school_address', $school_address );
    ...
    <div class="ifs-educore-general-root">
        ...
        <div class="ifs-educore-settings-card">
            <form method="POST" action="">
                ...
                <div class="ifs-educore-grid-row">
                    <div class="ifs-educore-field-node">
                        <label class="ifs-educore-label">
                            <?php esc_html_e( 'Official Phone Number', 'ifsedu-school-management' ); ?>
                        </label>
                        <input type="text" name="school_phone" class="ifs-educore-input" value="<?php echo esc_attr( $school_phone ); ?>" placeholder="<?php esc_attr_e( 'e.g. +8801234567890', 'ifsedu-school-management' ); ?>">
                    </div>

                    <div class="ifs-educore-field-node">
                        <label class="ifs-educore-label">
                            <?php esc_html_e( 'Official Email Address', 'ifsedu-school-management' ); ?>
                        </label>
                        <input type="email" name="school_email" class="ifs-educore-input" value="<?php echo esc_attr( $school_email ); ?>" placeholder="<?php esc_attr_e( 'e.g. info@school.edu', 'ifsedu-school-management' ); ?>">
                    </div>
                </div>

                <!-- Row 3: Physical Address -->
                <div class="ifs-educore-grid-row">
                    <div class="ifs-educore-field-node" style="grid-column: span 2;">
                        <label class="ifs-educore-label">
                            <?php esc_html_e( 'Institutional Address', 'ifsedu-school-management' ); ?>
                        </label>
                        <textarea name="school_address" class="ifs-educore-input" rows="3" placeholder="<?php esc_attr_e( 'Enter full physical street address...', 'ifsedu-school-management' ); ?>"><?php echo esc_textarea( $school_address ); ?></textarea>
                    </div>
                </div>

                <!-- Row 4: Institutional Logo & Principal Signature -->
                <div class="ifs-educore-grid-row">
                    <!-- Logo Upload -->
                    <div class="ifs-educore-field-node">
                        ...
                        <div class="ifs-educore-uploader-card">
                            <div class="ifs-educore-preview-box" id="ifs_logo_preview">
                                ...
                                <?php else : ?>
                                    <span class="dashicons dashicons-format-image ifs-educore-preview-placeholder-icon"></span>
                                <?php endif; ?>
                            </div>
                    ...
                    <div class="ifs-educore-field-node">
                        ...
                        <div class="ifs-educore-uploader-card">
                            <div class="ifs-educore-preview-box" id="ifs_sig_preview">
                                ...
                                <?php else : ?>
                                    <span class="dashicons dashicons-edit ifs-educore-preview-placeholder-icon"></span>
                                <?php endif; ?>
                            </div>
                ...
                <!-- Submit Button -->
                <div class="ifs-educore-submit-section">
    ...
    jQuery(document).ready(function($) {
        function setupMediaUploader(btnSelector, inputSelector, previewSelector, removeBtnSelector, modalTitle) {
            ...
            $(removeBtnSelector).on('click', function(e) {
                e.preventDefault();
                $(inputSelector).val('');
                $(previewSelector).html('<span class="dashicons dashicons-format-image ifs-educore-preview-placeholder-icon"></span>');
                $(this).hide();
            });
        }
