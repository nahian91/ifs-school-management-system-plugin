...
function educore_staff_list_view() {
    ...
    <div class="ifs-educore-staff-list-root">
        <!-- Header Title & Action CTA -->
        <div class="ifs-educore-staff-header-flex">
            <h2 class="ifs-educore-staff-main-title">
                <span class="dashicons dashicons-groups ifs-educore-staff-title-icon"></span> 
                <?php esc_html_e( 'Teachers & Staff Directory', 'ifsedu-school-management' ); ?>
            </h2>
            <a href="<?php echo esc_url( $add_url ); ?>" class="ifs-educore-btn-success-primary">
                + <?php esc_html_e( 'Add New Staff Member', 'ifsedu-school-management' ); ?>
            </a>
        </div>

        <!-- Category Tabs Navigation (4 Tabs) -->
        <div class="ifs-educore-tabs-wrapper-block">
        ...
        <div class="ifs-educore-bento-card-container">
            <table class="table table-striped table-hover align-middle educore-datatable w-100">
                <thead class="table-light">
                    <tr>
                        <th style="width: 70px;" class="ifs-educore-table-cell-center"><?php esc_html_e( 'Order', 'ifsedu-school-management' ); ?></th>
                        ...
                        <th class="ifs-educore-table-cell-right" style="width: 220px;"><?php esc_html_e( 'Actions', 'ifsedu-school-management' ); ?></th>
                    </tr>
                </thead>
                <tbody>
                    <?php if ( ! empty( $staff_members ) ) : ?>
                        ...
                        <tr>
                            ...
                            <td class="ifs-educore-table-cell-center">
                            ...
                            <!-- Name & WP User Link -->
                            <td>
                                <strong class="ifs-educore-staff-name-strong"><?php echo esc_html( $full_name ); ?></strong>
                                <?php if ( ! empty( $staff->wp_user_id ) ) : ?>
                                    <small class="ifs-educore-wp-user-small">
                            ...
                            <!-- Designation -->
                            <td>
                                <span class="ifs-educore-designation-badge">
                    ...
                    <?php else : ?>
                        <tr>
                            <td colspan="6" class="ifs-educore-table-cell-center text-muted py-4">
