        ...
        <div class="ifs-educore-bento-card">
            ...
            <form method="POST" action="" id="educoreUserForm">
                ...
                <div class="ifs-educore-form-grid">
                    ...
                    <!-- Link Staff Member -->
                    <div class="ifs-educore-field-group full-width">
                    ...
                    <div class="ifs-educore-field-group">
                        <label class="ifs-educore-field-label"><?php esc_html_e( 'Username (Login ID)', 'ifsedu-school-management' ); ?> <span class="ifs-educore-required">*</span></label>
                        <input type="text" name="user_login" id="educore_user_login" class="ifs-educore-input <?php echo $edit_user ? 'ifs-educore-input-readonly' : ''; ?>" value="<?php echo $edit_user ? esc_attr( $edit_user->user_login ) : ''; ?>" <?php echo $edit_user ? 'readonly' : 'required'; ?> placeholder="<?php esc_attr_e( 'e.g. teacher_john', 'ifsedu-school-management' ); ?>">
                    </div>

                    <!-- Email -->
                    <div class="ifs-educore-field-group">
                        <label class="ifs-educore-field-label"><?php esc_html_e( 'Email Address', 'ifsedu-school-management' ); ?> <span class="ifs-educore-required">*</span></label>
                    ...
                    <div class="ifs-educore-field-group">
                        <label class="ifs-educore-field-label"><?php echo $edit_user ? esc_html__( 'New Password (Leave blank to keep unchanged)', 'ifsedu-school-management' ) : esc_html__( 'Password', 'ifsedu-school-management' ) . ' <span class="ifs-educore-required">*</span>'; ?></label>
                        ...
                        <div class="ifs-educore-strength-container">
                            <div class="ifs-educore-strength-track">
                                <div id="educorePasswordStrengthBar" class="ifs-educore-strength-bar"></div>
                            </div>
                            <small id="educorePasswordStrengthText" class="ifs-educore-strength-text"></small>
                        </div>
                    </div>

                    <!-- Re-type Password with Show/Hide Toggle -->
                    <div class="ifs-educore-field-group">
                        <label class="ifs-educore-field-label"><?php esc_html_e( 'Re-Type Password', 'ifsedu-school-management' ); ?> <?php echo $edit_user ? '' : '<span class="ifs-educore-required">*</span>'; ?></label>
                        <div class="ifs-educore-password-wrapper">
                        ...
                        <small id="educorePasswordMatchText" class="ifs-educore-match-text"></small>
                    </div>

                    <!-- System Role Dropdown -->
                    <div class="ifs-educore-field-group full-width">
                        <label class="ifs-educore-field-label"><?php esc_html_e( 'System Staff Role & Access Level', 'ifsedu-school-management' ); ?> <span class="ifs-educore-required">*</span></label>
                ...
                <div class="ifs-educore-form-actions">
                    <button type="submit" name="educore_save_user_btn" id="educoreSubmitBtn" class="ifs-educore-btn-primary">
