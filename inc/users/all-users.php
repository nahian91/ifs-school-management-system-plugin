...
function educore_users_list_view() {
    ...
    <div class="ifs-educore-users-root">
        <div class="ifs-educore-bento-card">
            ...
            <div class="ifs-educore-table-responsive">
                <table class="ifs-educore-users-table">
                    <thead>
                        <tr>
                            <th class="col-avatar"><?php esc_html_e( 'Avatar', 'ifsedu-school-management' ); ?></th>
                            ...
                            <th class="col-actions"><?php esc_html_e( 'Actions', 'ifsedu-school-management' ); ?></th>
                        </tr>
                    </thead>
                    <tbody>
                        <?php if ( ! empty( $all_users ) ) : foreach ( $all_users as $user_obj ) : 
                            ...
                            $user_view_url = add_query_arg( array( 'page' => 'school_management_system', 'tab' => 'users', 'sub' => 'view', 'user_id' => $user_obj->ID ), $base_admin_url );
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    <a href="mailto:<?php echo esc_attr( $user_obj->user_email ); ?>" class="ifs-educore-email-link">
                                ...
                                <td>
                                    <small class="ifs-educore-date-text">
                                        <?php echo esc_html( $reg_date_formatted ); ?>
                                    </small>
                                </td>
                                <td class="col-actions">
                                    <div class="ifs-educore-action-group">
                                        <a href="<?php echo esc_url( $user_view_url ); ?>" class="ifs-educore-square-btn ifs-educore-btn-view" title="<?php esc_attr_e( 'View User Profile', 'ifsedu-school-management' ); ?>">
                                            <span class="dashicons dashicons-visibility"></span>
                                        </a>

                                        <?php if ( ! $is_governing ) : ?>
                                            <?php if ( ! $is_target_admin || $is_admin ) : ?>
                                                <a href="<?php echo esc_url( $user_edit_url ); ?>" class="ifs-educore-square-btn ifs-educore-btn-edit" title="<?php esc_attr_e( 'Edit User', 'ifsedu-school-management' ); ?>">
                                                    <span class="dashicons dashicons-edit"></span>
                                                </a>
                                            <?php endif; ?>

                                            <?php if ( $user_obj->ID !== $current_user_id && ( ! $is_target_admin || $is_admin ) ) : ?>
                                                <a href="<?php echo esc_url( $user_del_url ); ?>" class="ifs-educore-square-btn ifs-educore-btn-delete" title="<?php esc_attr_e( 'Delete User', 'ifsedu-school-management' ); ?>" onclick="return confirm('<?php echo esc_js( __( 'Are you sure you want to delete this user?', 'ifsedu-school-management' ) ); ?>');">
                                                    <span class="dashicons dashicons-trash"></span>
                                                </a>
                                            <?php endif; ?>
                                        <?php else : ?>
                                            <span class="ifs-educore-view-only-text"><?php esc_html_e( 'View Only', 'ifsedu-school-management' ); ?></span>
                                        <?php endif; ?>
                                    </div>
                                </td>
                            </tr>
                        <?php endforeach; else : ?>
                            <tr>
                                <td colspan="7" class="ifs-educore-empty-cell">
